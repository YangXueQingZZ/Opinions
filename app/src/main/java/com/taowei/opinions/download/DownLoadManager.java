...
import com.taowei.opinions.db.DataKeeper;
...
public class DownLoadManager {
    ...
    private void recoverData(Context context, String userID){
        ...
        ArrayList<SQLInfo> sqlDownloadInfoList = null;
        if(userID == null){
        ...
        if (sqlDownloadInfoList.size() > 0) {
            ...
            for (int i = 0; i < listSize; i++) {
                SQLInfo sqlDownLoadInfo = sqlDownloadInfoList.get(i);
    ...
    public ArrayList<TaskInfo> getAllTask() {
        ...
        for (int i = 0; i < listSize; i++) {
            DownLoader deletedownloader = taskList.get(i);
            SQLInfo sqldownloadinfo = deletedownloader.getSQLDownLoadInfo();
    ...
    public TaskInfo getTaskInfo(String taskID) {
        ...
        SQLInfo sqldownloadinfo = downloader.getSQLDownLoadInfo();
